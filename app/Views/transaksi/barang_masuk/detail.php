        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Detail informasi barang masuk dan daftar item</p>
                </div>
                <div class="btn-group-custom">
                    <a href="<?= site_url('transaksi/masuk') ?>" class="btn btn-secondary">
                        <i class="las la-arrow-left mr-1"></i> Kembali
                    </a>
                    <a href="<?= site_url('transaksi/masuk/cetak_pdf/' . $barangMasuk['id']) ?>" target="_blank"
        ...
        <div class="col-lg-4 col-md-6 mb-3">
            <div class="card h-100 border-0 shadow-sm text-center">
                <div class="card-body">
                    ...
                    <h6 class="text-muted mb-2">Tanggal Masuk</h6>
                    <h5 class="mb-0 text-dark font-weight-bold"><?= tgl_indo($barangMasuk['tanggal_masuk']) ?></h5>
                </div>
            </div>
        </div>
            ...
            <div class="card h-100 border-0 shadow-sm text-center">
                <div class="card-body">
                    <div class="icon-circle bg-success-light mb-3">
                        <i class="las la-building text-success" style="font-size: 2rem;"></i>
                    </div>
                    <h6 class="text-muted mb-2">Vendor</h6>
                    <h5 class="mb-0 text-dark font-weight-bold"><?= $barangMasuk['nama_vendor'] ?? '-' ?></h5>
                </div>
            </div>
        </div>
            ...
            <div class="card border-0 shadow-sm">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover mb-0" id="tabel_masuk">
